...
1. Run /andthen:map-codebase to auto-generate ARCHITECTURE.md, CONVENTIONS.md, and STACK.md
...
**If yes**: Run `/andthen:map-codebase` (or instruct the user to run it), then proceed with Step 2a using the generated documents as a foundation. Skip creating ARCHITECTURE.md, CONVENTIONS.md, and STACK.md since map-codebase already produced them.
