...
Counter-calibration for the Red-Team sub-lens. Apply on its own, or alongside `review-calibration.md` and any lens-specific calibration when those are loaded — it does not replace them.
