...
1. Invoke the `andthen:simplify-code` skill with `$ARGUMENTS` passed through verbatim (flags, paths, scope/description – all preserved). Use the Skill tool (`/andthen:simplify-code <args>`).
