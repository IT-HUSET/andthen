...
- Avoid scope creep across files. Within files you are already editing for a fix, apply the Boy Scout rule — clean up small co-located issues you encounter. Do not expand into untouched files or rewrite nearby docs unless required to resolve a finding or prevent a regression.
