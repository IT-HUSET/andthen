---
description: End-to-end browser testing for web apps – discover journeys, run interactive tests, validate responsive behavior. Trigger on 'test the app end to end', 'e2e test', 'browser test'.
user-invocable: true
