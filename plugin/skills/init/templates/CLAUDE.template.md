...
&dagger; Organized by version or feature name: `docs/specs/{version-or-feature}/prd.md`, `plan.md`, `.technical-research.md`, and per-story FIS files (`s01-*.md`, `s02-*.md`, composite `s0N-s0M-*.md`, and `thin-specs.md`) co-located in the same directory. Standalone specs go directly in `docs/specs/`.
