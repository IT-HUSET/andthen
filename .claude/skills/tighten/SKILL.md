...
3. **Wording audit** – `rg 'andthen:[a-z-]+' CLAUDE.md plugin/ docs/`: no new skill-as-agent drift; type-noun placement per CLAUDE.md § Skill And Agent Model / `SYS-15` (noun adjacent in prose and after invocation verbs; bare identifiers sanctioned in assertional spec text).
