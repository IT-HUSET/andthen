...
- `OPS-64` update-decisions still-current: refuses with BLOCKED: Decisions document not found at <path> – run andthen:init to scaffold it when the Decisions document is absent; does not create it (DECISIONS.md is NOT a file-creation exception – OPS-53 unchanged).
